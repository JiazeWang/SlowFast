...
def resnet50_3d_slowonly(pretrained=False, feat=False, **kwargs):
    ...
    """
    model = ResNet3D_nodown([Bottleneck3D_000, Bottleneck3D_000, Bottleneck3D_100, Bottleneck3D_100],
...
def resnet26_3d_slowonly(pretrained=False, feat=False, **kwargs):
    """Constructs a ResNet-50 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
